...
Here is an example of how we might reconciling fields between 2012 and 2014.
...
# INCLUSIVE XPATH STATEMENT

 [47] "/Return/ReturnData/IRS990/*[self::GrossReceipts or self::GrossReceiptsAmt]"
 [48] "/Return/ReturnData/IRS990/*[self::GroupReturnForAffiliates or self::GroupReturnForAffiliatesInd]"
 [49] "/Return/ReturnData/IRS990/*[self::Organization501c3 or self::Organization501c3Ind]"
 [50] "/Return/ReturnData/IRS990/*[self::WebSite or self::WebsiteAddressTxt]"
 [51] "/Return/ReturnData/IRS990/*[self::TypeOfOrganizationCorporation or self::TypeOfOrganizationCorpInd]"
 [52] "/Return/ReturnData/IRS990/*[self::YearFormation or self::FormationYr]"
 [53] "/Return/ReturnData/IRS990/*[self::StateLegalDomicile or self::LegalDomicileStateCd]"
 [54] "/Return/ReturnData/IRS990/*[self::ActivityOrMissionDescription or self::ActivityOrMissionDesc]"
 [55] "/Return/ReturnData/IRS990/*[self::NbrVotingMembersGoverningBody or self::VotingMembersGoverningBodyCnt]"
 [56] "/Return/ReturnData/IRS990/*[self::NbrIndependentVotingMembers or self::VotingMembersIndependentCnt]" 
 [57] "/Return/ReturnData/IRS990/*[self::TotalNbrEmployees or self::TotalEmployeeCnt]"
 [58] "/Return/ReturnData/IRS990/*[self::TotalNbrVolunteers or self::TotalVolunteersCnt]"
 [59] "/Return/ReturnData/IRS990/*[self::TotalGrossUBI or self::TotalGrossUBIAmt]"
 [60] "/Return/ReturnData/IRS990/*[self::NetUnrelatedBusinessTxblIncome or self::NetUnrelatedBusTxblIncmAmt]"
