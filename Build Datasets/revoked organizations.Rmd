...
dat.revoked <- read.delim( file="./Data/data-download-revocation.txt", 
            header = FALSE, 
            sep = "|", 
            quote = "",
            dec = ".", 
...
dat.revoked$FileYear < substr( dat.revoked$Tax.Year, 1, 4 )
...
write.csv( dat.revoked, "RevokedOrganizations", row.names=F )


# IN STATA

library( foreign )
write.dta( dat.revoked, "RevokedOrganizations.dta" )
