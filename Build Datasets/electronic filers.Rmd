...
electronic.json <- "https://s3.amazonaws.com/irs-form-990/index.json.gz"

download.file( electronic.json, "electronic filers.gz" )

gunzip("electronic filers.gz", remove=TRUE )  


# CREATE A DATA FRAME OF ELECTRONIC FILERS FROM IRS JSON FILES

data.ef <- fromJSON( txt="990index-fixed.json" )[[1]]
